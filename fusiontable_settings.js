...
*/
    ...
    searchPage: {
        ...
        columns: [
            ...
            { label: "CustStatus", type: "dropdown", entries: [["...","",true]], foreach: "CustStatus" },
            { label: "TradeLayer", type: "dropdown", entries: [["...","",true]], foreach: "TradeLayer" },
            { label: "TradeCategory", type: "dropdown", entries: [["...","",true]], foreach: "TradeCategory" },
            { label: "FM", type: "dropdown", entries: [["...","",true]], foreach: "FM" },
            { label: "DSPV", type: "dropdown", entries: [["...","",true]], foreach: "DSPV" },
            { label: "TE", type: "dropdown", entries: [["...","",true]], foreach: "TE" },
            { label: "InRP", type: "dropdown", entries: [["...","",true]], foreach: "InRP" },
            { label: "SUPPLIER", type: "dropdown", entries: [["...","",true]], foreach: "SUPPLIER" },
            { label: "IND mc", type: "slider", column: "INDmc"},
            { label: "PMI mc", type: "slider", column: "PMImc"},
            { label: "Share %", type: "slider", column: "Share"},
            { label: "PPOSM", type: "dropdown", entries: [["...","",true]], foreach: "PPOSM" },
            { label: "INV", type: "dropdown", entries: [["...","",true]], foreach: "INV" },
            { label: "HTS", type: "dropdown", entries: [["...","",true]], foreach: "HTS" },
        ]
    },
